...
function drawDifficultySelect() {
    ...
    const levels = [
        { key: 'EASY', label: 'EASY', icon: 'shieldEasy', sub: 'Beginner', color: THEME.accent, power: 1 },
...
function drawTournamentMenu() {
    ...
    ctx.fillText('Full FIFA World Cup Style', 450, formatY + 52);
...
function drawTournamentResult(matchResult) {
    ...
    else { titleText = 'DEFEAT'; titleColor = THEME.red; titleIcon = 'shieldEasy'; }
...
function drawPauseMenu() {
    ...
    themePill(350, 295, 200, 50, 'MAIN MENU', THEME.red, { fontSize: 20, icon: 'home' });
