...
window.addEventListener('keydown', (e) => {
    ...
    // 'P' remains the primary way to pause/back-out; Escape still triggers
    // the same game actions below, it's just no longer prevented from also
    // reaching the browser/portal.
...
function resumeSavedTournament() {
    ...
    // Land wherever the saved tournament actually was — same rule used
    // elsewhere for navigating between the group stage and the knockout
    // bracket screens.
...
canvas.addEventListener('wheel', (e) => {
    ...
    if (currentState === 'CREDITS') {
        ...
        const maxScroll = Math.max(0, (19 * 34) - 370);
