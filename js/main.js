...
// ===== CRAZYGAMES REQUIREMENT: "Common fixes" =====
// Per CrazyGames' HTML5 resources page, these window/document-level listeners
// are their standard recommended fix for unwanted page scroll and the right-
// click context menu breaking immersion on the portal. Keydown scroll (Space/
// Arrow keys/Enter) is already prevented per-key inside input.js's keydown
// handler (Escape is deliberately left alone there — CrazyGames reserves it
// to exit their own fullscreen), and canvas wheel events are already handled
// for in-game scrolling (tournament screens). This just closes the remaining
// gap: mouse-wheel scroll anywhere else on the page, and the browser's
// right-click menu.
